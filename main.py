...
##SHOTOKU ## PANTELIS PANTELIDIS ## WEb scrapper - > Opens the robot web interface and mines all the robot settings. Exports them in a text file with a specific format.
...
def start_action():
    ...
    if ip_address:
        messagebox.showinfo("Start Button", f"Starting process for IP: {ip_address}")
        ...
        url = f"http://{ip_address}/Web/General.htm"
        driver.get(url)
        ...
        General1 = [CameraNumber, HeadModel, HeightModel, TrackModel, AllowHeightOnly, ControlCameraCCU, ControlTRP100,
                    ControlSmartped]
        ...
        General1S = [CameraNumberT, HeadModelT, HeightModelT, TrackModelT, AllowHeightOnlyT, ControlCameraCCUT,
                     ControlTRP100T, ControlSmartpedT]
        ...
        General2 = [AccelerationAtLimit, ADCOn, CheckLocalRemote, DeleteLimitFiles, EnableDisplay, HandControlsDirect,
                    HeadLatency, JoystickVelocity]
        ...
        General2S = [AccelerationAtLimitT, ADCOnT, CheckLocalRemoteT, DeleteLimitFilesT, EnableDisplayT,
                     HandControlsDirectT, HeadLatencyT, JoystickVelocityT]
        ...
        General3 = [LimitDistance, LimitTimeWindow, NewSeQMethod, PositionalTrimSmoothing, RelayDriveMode, SamplelTime,
                    SeqNth, StartupDelay]
        ...
        PositionalTrimSmoothingT = driver.find_element(By.XPATH,
                                                       "//td[normalize-space()='Positional Trim Smoothing']").text
        ...
        General3S = [LimitDistanceT, LimitTimeWindowT, NewSeQMethodT, PositionalTrimSmoothingT, RelayDriveModeT,
                     SamplelTimeT, SeqNthT, StartupDelayT]
        ...
        General4 = [ToggleAtStore, ZOffRatio, ZoneDeadband, FaderMultiplier, LoggingLevel, Output1Mom, Output2Mom,
                    Output3Mom]
        ...
        General4S = [ToggleAtStoreT, ZOffRatioT, ZoneDeadbandT, FaderMultiplierT, LoggingLevelT, Output1MomT,
                     Output2MomT, Output3MomT]
        ...
        UseLearnForLocalRemoteT = driver.find_element(By.XPATH,
                                                      "//td[normalize-space()='Use Learn For Local/Remote']").text
        ...
        Network1S = [IPT, GatewayAddressT, SubnetMaskT, CameraSelectIntervalT, NetworkFullDuplexT, NetworkSpeedT,
                     FilterSubnetT]
        ...
        Network2 = [UdpPort1, UdpPort2, OnAirPort, OnAirOutput, ListenPort, PrivateUdpPort, PrivateListenPort,
                    ServiceInterfacePort, CameraSelectBroadcastPort]
        ...
        CameraSelectBroadcastPortT = driver.find_element(By.XPATH,
                                                         "//td[normalize-space()='Camera Select Broadcast Port']").text

        Network2S = [UdpPort1T, UdpPort2T, OnAirPortT, OnAirOutputT, ListenPortT, PrivateUdpPortT, PrivateListenPortT,
                     ServiceInterfacePortT, CameraSelectBroadcastPortT]
        ...
        Pan2 = [DerivativeTime, IntegrationLimit, AccelFeedForward, KD, KI, KP, VelocityFeedForward,
                InterpolationFactor, MaximumAccel, MaximumVel, MinimumAccel, ProfileSubmode]
        ...
        Pan2S = [DerivativeTimeT, IntegrationLimitT, AccelFeedForwardT, KDT, KIT, KPT, VelocityFeedForwardT,
                 InterpolationFactorT, MaximumAccelT, MaximumVelT, MinimumAccelT, ProfileSubmodeT]
        ...
        Tilt1S = [TiltReverseT, TiltDriveInvertT, TiltHighLimitT, TiltLowLimitT, TiltJsMediumT, TiltJsFineT,
                  TiltMultiplierT]
        ...
        Tilt2 = [DerivativeTimeT, IntegrationLimitT, AccelFeedForwardT, KDT, KIT, KDT, VelocityFeedForwardT,
                 InterpolationFactorT, MaximumAccelT, MaximumVelT, MinimumAccelT, ProfileSubmodeT]
        ...
        Tilt2S = [DerivativeTimeTT, IntegrationLimitTT, AccelFeedForwardTT, KDTT, KITT, KDTT, VelocityFeedForwardTT,
                  InterpolationFactorTT, MaximumAccelTT, MaximumVelTT, MinimumAccelTT, ProfileSubmodeTT]
        ...
        Height1 = [HeightHighLimit, HeightLowLimit, HeightJsMedium, HeightJsFine, HeightMultiplier, TransitionZoneLimit,
                   ZoneTargetCoordinates, StallDetect, TachoFeedback]
        ...
        Height1S = [HeightHighLimitT, HeightLowLimitT, HeightJsMediumT, HeightJsFineT, HeightMultiplierT,
                    TransitionZoneLimitT, ZoneTargetCoordinatesT, StallDetectT, TachoFeedbackT]
        ...
        Height2 = [DerivativeTimeH, IntegrationLimitH, AccelFeedForwardH, KDH, KIH, KPH, VelocityFeedForwardH,
                   InterpolationFactorH, MaximumAccelH, MaximumVelH, MinimumAccelH, ProfileSubmodeH]
        ...
        Height2S = [DerivativeTimeHT, IntegrationLimitHT, AccelFeedForwardHT, KDHT, KIHT, KPHT, VelocityFeedForwardHT,
                    InterpolationFactorHT, MaximumAccelHT, MaximumVelHT, MinimumAccelHT, ProfileSubmodeHT]
        ...
        Track1 = [TrackHighLimit, TrackLowLimit, TrackMultiplier, TrackCalibrationDataFile, UseTrackZones,
                  Zone1highLimit, Zone2LowLimit, Zone3HighLimit, Zone4LowLimit]
        ...
        TrackCalibrationDataFileT = driver.find_element(By.XPATH,
                                                        "//td[normalize-space()='Track Calibration Data File']").text
        ...
        Track1S = [TrackHighLimitT, TrackLowLimitT, TrackMultiplierT, TrackCalibrationDataFileT, UseTrackZonesT,
                   Zone1highLimitT, Zone2LowLimitT, Zone3HighLimitT, Zone4LowLimitT]
        ...
        Track2 = [TrackBumper, BumperGPIO, RailSafeDirection, RailStop, TrackHeightSwitch, TrackUnsafeSpeed,
                  TrackCollisionCount]
        ...
        Track2S = [TrackBumperT, BumperGPIOT, RailSafeDirectionT, RailStopT, TrackHeightSwitchT, TrackUnsafeSpeedT,
                   TrackCollisionCountT]
        ...
        Track3S = [TPBDirectionT, TPBOnT, TPBOtherDeviceT, TPBSafeDirectionT, TPBUnsafeDistanceT, TPBFreqWhenMovingT,
                   TPBPortT]
        ...
        Lens1 = [SerialLensProtocol, LensSerialMode, SerialLensExtOption, LensExRelayBit, UseLensIfForIris, ZoomCRCPS,
                 SetFocusTimeout, SetFocusZoomLevel]
        ...
        Lens1S = [SerialLensProtocolT, LensSerialModeT, SerialLensExtOptionT, LensExRelayBitT, UseLensIfForIrisT,
                  ZoomCRCPST, SetFocusTimeoutT, SetFocusZoomLevelT]
        ...
        Lens2 = [LensFocusDirection, FocusBacklashConstant, FocusHighLimit, FocusLowLimit, FocusMaxAcceleration,
                 FocusMaxVelocity, FocusMinAcceleration, FocusMultiplier, FocusStartPosition]
        ...
        Lens2S = [LensFocusDirectionT, FocusBacklashConstantT, FocusHighLimitT, FocusLowLimitT, FocusMaxAccelerationT,
                  FocusMaxVelocityT, FocusMinAccelerationT, FocusMultiplierT, FocusStartPositionT]
        ...
        Lens3 = [LensIrisDirection, IrisMaxAcceleration, IrisMaxVelocity, IrisMinAcceleration, IrisMultiplier,
                 IrisStartPosition]
        ...
        Lens3S = [LensIrisDirectionT, IrisMaxAccelerationT, IrisMaxVelocityT, IrisMinAccelerationT, IrisMultiplierT,
                  IrisStartPositionT]
        ...
        Lens4S = [LocalFocusOffsetT, LocalFocusScalingT, LocalFocusTimeT, LocalZoomDeadbandT, LocalZoomRangeT,
                  LocalZoomTimeT]
        ...
        Lens5 = [LensZoomDirection, ZoomBacklashConstant, ZoomHighLimit, ZoomLowLimit, ZoomMaxAccel, ZoomMaxVelocity,
                 ZoomMinAccel, ZoomMultiplier, ZoomStartPosition]
        ...
        Lens5S = [LensZoomDirectionT, ZoomBacklashConstantT, ZoomHighLimitT, ZoomLowLimitT, ZoomMaxAccelT,
                  ZoomMaxVelocityT, ZoomMinAccelT, ZoomMultiplierT, ZoomStartPositionT]
        ...
        Robot1 = [XReverse, XHighLimit, XLowLimit, XJsMedium, XJsFine, YReverse, YHighLimit, YLowLimit, YJsMedium,
                  YJsFine]
        ...
        Robot1S = [XReverseT, XHighLimitT, XLowLimitT, XJsMediumT, XJsFineT, YReverseT, YHighLimitT, YLowLimitT,
                   YJsMediumT, YJsFineT]
        ...
        Robot2 = [DerivTimeR, VelocityFeedForwardR, AccelFeedForwardR, KDR, KIR, KPR, MaximumAccelR, MaximumVelR,
                  MinimumAccelR]
        ...
        Robot2S = [DerivTimeRT, VelocityFeedForwardRT, AccelFeedForwardRT, KDRT, KIRT, KPRT, MaximumAccelRT,
                   MaximumVelRT, MinimumAccelRT]
        ...
        Limits = [PanHighLimit, PanLowLimit, TiltHighLimit, TiltLowLimit, HeightHighLimit, HeightLowLimit,
                  FocusHighLimit, FocusLowLimit, ZoomHighLimit, ZoomLowLimit]
        ...
        LimitsS = [PanHighLimitT, PanLowLimitT, TiltHighLimitT, TiltLowLimitT, HeightHighLimitT, HeightLowLimitT,
                   FocusHighLimitT, FocusLowLimitT, ZoomHighLimitT, ZoomLowLimitT]
        ...
        VR1 = [VRDataProtocol, VRDataBaudRate, VRPanEncoderRange, VRPanInvert, VRPanOffset, VRTiltEncoderRange,
               VRTiltInvert, VRTiltOffset, VRHeightEncoderRange, VRHeightInvert, VRHeightOffset, VRHeightTotalMovement]
        ...
        VRHeightTotalMovementT = driver.find_element(By.XPATH,
                                                     "//td[normalize-space()='VR Height Total Movement']").text

        VR1S = [VRDataProtocolT, VRDataBaudRateT, VRPanEncoderRangeT, VRPanInvertT, VRPanOffsetT, VRTiltEncoderRangeT,
                VRTiltInvertT, VRTiltOffsetT, VRHeightEncoderRangeT, VRHeightInvertT, VRHeightOffsetT,
                VRHeightTotalMovementT]
        ...
        VR2 = [VRFocusInvert, VRFocusOffset, VRFocusScaling, VRZoomInvert, VRZoomLensCalibration, VRZoomOffset,
               VRZoomScaling]
        ...
        VRZoomLensCalibrationT = driver.find_element(By.XPATH,
                                                     "//td[normalize-space()='VR Zoom Lens Calibration']").text
        ...
        VR2S = [VRFocusInvertT, VRFocusOffsetT, VRFocusScalingT, VRZoomInvertT, VRZoomLensCalibrationT, VRZoomOffsetT,
                VRZoomScalingT]
        ...
        # open file
        with open('cmcv2settings.text', 'w+') as f:
            # write elements of list
            for i in range(len(settings_names2)):
                f.write('%s\n' % settings_names2[i])
                f.write('%s\n' % settings_values2[i])
